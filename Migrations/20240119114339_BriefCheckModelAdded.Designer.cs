...
namespace CodeBuilder.Migrations
{
    ...
    [Migration("20240119114339_BriefCheckModelAdded")]
    partial class BriefCheckModelAdded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CodeBuilder.Models.Briefs.BriefCheckModel", b =>
                {
                    ...
                    b.HasKey("BriefId", "CheckId");

                    b.HasIndex("CheckId");

                    b.ToTable("BriefChecks");
                });

            modelBuilder.Entity("CodeBuilder.Models.Briefs.BriefModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CodeBuilder.Models.Briefs.BriefCheckModel", b =>
                {
                    b.HasOne("CodeBuilder.Models.Briefs.BriefModel", "Brief")
                        .WithMany("Checks")
