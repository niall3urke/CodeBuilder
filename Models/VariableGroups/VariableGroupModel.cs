...
{
    public class VariableGroupModel : ICodable, IBucket<VariableGroupVariableModel>
    {

        // Properties 

        public List<VariableGroupVariableModel> Children { get; set; }
        ...
        {
            Children = new List<VariableGroupVariableModel>();
